...
class WorkoutRecommendationPage extends StatefulWidget {
  const WorkoutRecommendationPage({super.key});

  @override
  State<WorkoutRecommendationPage> createState() => _WorkoutRecommendationPageState();
}

class _WorkoutRecommendationPageState extends State<WorkoutRecommendationPage> {
